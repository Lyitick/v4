...
def settings_home_inline_keyboard() -> InlineKeyboardMarkup:
    ...
    inline_keyboard = [
        [
            ...
            InlineKeyboardButton(text="💸 Расход", callback_data="st:expense"),
        ],
        [
...
def expense_settings_inline_keyboard() -> InlineKeyboardMarkup:
    """Inline keyboard for expense settings actions."""

    inline_keyboard = [
        [
            InlineKeyboardButton(text="➕ Категорию", callback_data="exp:add"),
            InlineKeyboardButton(text="➖ Категорию", callback_data="exp:del_menu"),
        ],
        [
            InlineKeyboardButton(text="✏️ Проценты", callback_data="exp:pct_menu"),
            InlineKeyboardButton(text="⬅️ Назад", callback_data="st:home"),
        ],
    ]
    return InlineKeyboardMarkup(inline_keyboard=inline_keyboard)
...
def expense_categories_select_keyboard(
    categories: list[dict], action_prefix: str, back_callback: str
) -> InlineKeyboardMarkup:
    """Inline keyboard for selecting an expense category."""
